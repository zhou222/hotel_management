...
<body class="sarchbody">
	...
	<form method="post" action="servlet/searchRoom">
	<li><label>房间类型</label>  
    <div class="vocation">
    <select name="selected" class="select3">
    ...
    <ul class="seachform1">
    <li class="sarchbtn"><label>&nbsp;</label><input name="" type="submit" class="scbtn" value="查询"/>   <input name="" type="button" class="scbtn1" value="更多条件"/>   </li>  
    </ul>
